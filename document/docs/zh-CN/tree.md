      ...
      renderContent(h, { node, data }) {
        return (
          <span style="flex: 1; display: flex; align-items: center; justify-content: space-between; font-size: 14px; padding-right: 8px;">
            ...
            <span>
              <py-button style="font-size: 12px;" type="text" on-click={ () => this.append(data) }>Append</py-button>
              <py-button style="font-size: 12px;" type="text" on-click={ () => this.remove(node, data) }>Delete</py-button>
            </span>
          </span>);
      },
...
::: demo
```html
<py-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></py-tree>
...
<div class="buttons">
  <py-button @click="getCheckedNodes">通过 node 获取</py-button>
  <py-button @click="getCheckedKeys">通过 key 获取</py-button>
  <py-button @click="setCheckedNodes">通过 node 设置</py-button>
  <py-button @click="setCheckedKeys">通过 key 设置</py-button>
  <py-button @click="resetChecked">清空</py-button>
</div>
