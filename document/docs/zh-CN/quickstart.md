...
我们提供了通用的[项目模板](https://github.com/iPinYou/pyff-vue-sample)，你可以直接使用。对于 Laravel 用户，我们也准备了相应的[模板](https://github.com/ElementUI/element-in-laravpy-starter)，同样可以直接下载使用。
