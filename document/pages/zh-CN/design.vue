...
<template>
  <div>
    <h2>设计原则</h2>
    <py-row :gutter="14" class="cards">
      <py-col :xs="12" :sm="6">
        <div class="card">
          <img src="~document/assets/images/consistency.png" alt="Consistency">
          <h4>一致</h4>
      ...
      <py-col :xs="12" :sm="6">
        <div class="card">
          <img src="~document/assets/images/feedback.png" alt="Feedback">
          <h4>反馈</h4>
          <span>Feedback</span>
        </div>
      </py-col>
      <py-col :xs="12" :sm="6">
        <div class="card">
          <img src="~document/assets/images/efficiency.png" alt="Efficiency">
          <h4>效率</h4>
      ...
      <py-col :xs="12" :sm="6">
        <div class="card">
          <img src="~document/assets/images/controllability.png" alt="Controllability">
          <h4>可控</h4>
